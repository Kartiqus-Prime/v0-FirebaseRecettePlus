    ...
    final faqs = [
      {
        ...
        'answer': 'Appuyez sur l\'icône cœur sur n\'importe quelle recette pour l\'ajouter à vos favoris.',
      },
      {
        'question': 'Comment modifier mon profil ?',
        'answer': 'Allez dans l\'onglet Profil, puis appuyez sur "Modifier le profil" pour changer vos informations.',
      },
      {
        'question': 'Comment vérifier mon numéro de téléphone ?',
        'answer': 'Dans la page de modification du profil, entrez votre numéro et appuyez sur "Vérifier". Vous recevrez un SMS avec un code.',
      },
      {
        'question': 'Comment rechercher des recettes ?',
        'answer': 'Utilisez la barre de recherche dans l\'onglet Recettes ou filtrez par catégorie.',
      },
      {
        'question': 'Mes données sont-elles sécurisées ?',
        'answer': 'Oui, nous utilisons Firebase pour sécuriser vos données avec un chiffrement de niveau entreprise.',
      },
    ];
